<?php
include "models/ManagerAnalystModel.php";

class ManagerAnalystController extends Controller {
    use AnalystModel;
    ...
    public function index()
    {
        ...
        $this->loadView("ManagerAnalystByDateView.php", ["salesData" => $salesData]);
    }
    public function analyst() {
        ...
        // truyền dữ liệu và hiển thị view
        $this->loadView("ManagerListSoldProductView.php", ["salesData" => $salesData]);
    }   
}
