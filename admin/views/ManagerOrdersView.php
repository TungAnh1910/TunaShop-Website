                ...
                <?php foreach ($data as $rows) : ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <?php if ($rows->status == 0) : ?>
                                <a href="index.php?controller=managerorders&action=delivery&id=<?php echo $rows->id; ?>" class="label label-info">Giao hàng</a>
                                <a href="index.php?controller=managerorders&action=cancel&id=<?php echo $rows->id; ?>" class="label label-info">Hủy</a>
                                &nbsp;&nbsp;
                            <?php endif; ?>
                            <a href="index.php?controller=managerorders&action=detail&id=<?php echo $rows->id; ?>" class="label label-success">Chi tiết</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
