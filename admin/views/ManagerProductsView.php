...
<div class="col-md-12">
    <div style="margin-bottom:5px;">
        <a href="index.php?controller=managerproducts&action=create" class="btn btn-primary">Thêm sản phẩm</a>
    </div>
        ...
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                ...
                <?php foreach ($data as $rows) : ?>
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a href="index.php?controller=managerproducts&action=update&id=<?php echo $rows->id; ?>">Sửa</a>&nbsp;
                            <a href="index.php?controller=managerproducts&action=delete&id=<?php echo $rows->id; ?>" onclick="return window.confirm('Are you sure?');">Xóa</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
            ...
            <ul class="pagination">
                ...
                <?php for ($i = 1; $i <= $numPage; $i++) : ?>
                    <li class="page-item"><a href="index.php?controller=managerproducts&p=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
                <?php endfor; ?>
            </ul>
        </div>
    </div>
