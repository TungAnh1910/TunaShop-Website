...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>TunaShop</b>Manager</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="index.php?controller=managercategories">
                        <i class="fa fa-th"></i> <span>Danh mục sản phẩm</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?controller=managerproducts">
                        <i class="fa fa-th"></i> <span>Danh sách sản phẩm</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?controller=managerorders">
                        <i class="fa fa-th"></i> <span>Đơn hàng</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?controller=managernews">
                        <i class="fa fa-th"></i> <span>Tin tức</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?controller=managercustomers">
                        <i class="fa fa-th"></i> <span>Quản lý customer</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <i class="fa fa-th"></i> <span>Thống kê doanh số</span>
                    </a>
                </li>
                <li>
