...
<body>
    ...
    <div class="card-header bg-dark">
        <div class="row">
            <div class="col-md-3">
                <a href="#" style="font-family:Tahoma; line-height: 50px; color: #fff; font-weight: 700; font-size:20px; padding-left:270px;">
                    <?php
                ...
                <div class="col-md-9">
                    ...
                    <ul class="pagination">
                        ...
                        <?php for ($i = 1; $i <= $numPage; $i++) : ?>
                            <li class="page-item"><a href="index.php?controller=products&action=category&id=<?php echo $category_id; ?>&p=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
                        <?php endfor; ?>
                    </ul>
                    <style type="text/css">
                        .pagination {
