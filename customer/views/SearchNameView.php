...
<body>
    ...
    <div class="card-header bg-dark">
        <div class="row">
            <div class="col-md-3">
                <a href="#" style="font-family:Tahoma; padding-left:260px; line-height: 50px; color: #fff; font-weight: 700; font-size:20px;">
                    Tìm kiếm
                </a>
            </div>
            <div class="col-md-6">
                ...
                <div class="col-md-9">
                    ...
                    <ul class="pagination">
                        ...
                        <?php for ($i = 1; $i <= $numPage; $i++) : ?>
                            <li class="page-item"><a href="index.php?controller=search&action=name&p=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
                        <?php endfor; ?>
                    </ul>
                    <style type="text/css">
                        .pagination {
